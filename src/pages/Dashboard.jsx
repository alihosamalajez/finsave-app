    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-5 rounded-xl shadow border">
          ...
          {loading ? (
            <div className="h-6 w-24 bg-blue-200 rounded animate-pulse mt-2"></div>
          ) : (
        ...
        <div className="bg-white p-5 rounded-xl shadow border">
          ...
          {loading ? (
            <div className="h-6 w-24 bg-yellow-200 rounded animate-pulse mt-2"></div>
          ) : (
            <p className="text-xl font-semibold text-yellow-600">
              {lastExpense?.title || "لا يوجد"} :{" "}
              {lastExpense?.amount ? `₪ ${lastExpense.amount}` : ""}
            </p>
          )}
      ...
      <div className="grid md:grid-cols-3 gap-4 text-sm">
        <Link
          to="/expenses"
          className="bg-blue-100 p-4 rounded-xl flex items-center gap-3 hover:bg-blue-200 transition"
        >
        ...
        <Link
          to="/subscription"
          className="bg-green-100 p-4 rounded-xl flex items-center gap-3 hover:bg-green-200 transition"
        >
        ...
        <Link
          to="/goals"
          className="bg-yellow-100 p-4 rounded-xl flex items-center gap-3 hover:bg-yellow-200 transition"
        >
